...
public class App extends ListResourceBundle {
    private static ResourceBundle messagesBundle = ResourceBundle.getBundle("messages");
    private static ResourceBundle patternsBundle = ResourceBundle.getBundle("patterns");
