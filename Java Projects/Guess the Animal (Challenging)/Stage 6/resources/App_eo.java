...
public class App_eo extends ListResourceBundle {
    private static ResourceBundle messagesBundle = ResourceBundle.getBundle("messages_eo");
    private static ResourceBundle patternsBundle = ResourceBundle.getBundle("patterns_eo");

    private static List<Object[]> messagesList = Arrays.asList(
            new Object[][]{
                    {"fileName", "animals_eo."},
    ...
    private static List<Object[]> patternList = patternsBundle.keySet().stream()
