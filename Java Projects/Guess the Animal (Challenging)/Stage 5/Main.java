...
public class Main {
        ...
        switch (response) {
            ...
            case 3: {
                ...
                if (bst.hasAnimal(animal)) {
                    ...
                    bst.listFacts(animal).stream().map(s -> "- " + s).forEachOrdered(System.out::println);
                } else
    ...
    private static void parseResponse(Scanner scanner, BST.AnimalNode firstNode, Animal second, BST bst) {
        ...
        if (!pattern.matcher(input).matches()) {
            ...
            String positiveStatement = "It " + modalVerb + " " + ability + ".";
            String negativeStatement = "It " + modals.get(modalVerb)[1] + " " + ability + ".";
