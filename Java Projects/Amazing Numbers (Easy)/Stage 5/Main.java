...
public class Main {
    ...
    public static void mainMenu() {
        ...
        while (true) {
            ...
            //Handle cases where input is two or three arguments
            if (input.length >= 2) {
                BigInteger second = new BigInteger(input[1]);
                if (input.length == 2) {
                    nextN(first, second);
                } else //input.length == 3 {
                    nextNProperty(first, second, input[2]);
                }
            }
    ...
    private static void nextNProperty(BigInteger value, BigInteger n, String property) {
    ...
    private static boolean validateInput(String[] input) {
        ...
        //If present, validate second and third params
        if (input.length > 1) {
            try {
                BigInteger second = new BigInteger(input[1]);
