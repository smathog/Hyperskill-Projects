...
public class MatrixTester {
    public static void Test() {
        ...
        ArrayList<ArrayList<Complex>> input = new ArrayList<>();
        for (int i = 0; i < numRows; ++i)
            input.add(Arrays.stream(scanner.nextLine().split(" ")).map(Complex::parseComplex).collect(ArrayList::new, ArrayList::add, ArrayList::addAll));
