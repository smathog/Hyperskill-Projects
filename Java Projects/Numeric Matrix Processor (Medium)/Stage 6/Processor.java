...
public class Processor {
    ...
    public void matrixDeterminant() throws IllegalArgumentException {
        Matrix a = getSingleMatrix();
        System.out.println("The result is: ");
    ...
    private Matrix getSingleMatrix() {
        ...
        return Matrix.getMatrix(dims[0], dims[1]);
    }
