            ...
            switch (choice) {
                case "1":
                    if (expenses.isEmpty())
                        ...
                        System.out.println("Total: $" + String.format("%,.02f", currentExpenses));
                    }
                    break;
                case "2":
                    Arrays.stream(Expense.Type.values())
                            .sorted((t1, t2) -> (int) Double.compare((expensesByType.getOrDefault(t2, 0d)), expensesByType.getOrDefault(t1, 0d)))
                            .forEach(t -> System.out.println(t.name + " - $" + String.format("%,.02f", expensesByType.getOrDefault(t, 0d))));
                    System.out.println("Total sum: $" + String.format("%,.02f", currentExpenses));
                    break;
                case "3": {
                    System.out.println("Choose the type of purchase");
                    ...
                    if (!expenses.containsKey(t))
                        ...
                        System.out.println(t.name + ": ");
                        expenses.get(t).stream().sorted().forEach(System.out::println);
                        System.out.println("Total sum: $" + String.format("%,.02f", expensesByType.get(t)));
                    }
                }
                    break;
