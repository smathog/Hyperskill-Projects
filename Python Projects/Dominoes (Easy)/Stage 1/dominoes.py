...
if max_p1 == max_overall:
    ...
    status = "player"
print(f"Stock pieces: {[[i.first, i.second] for i in domino_set.stock_set]}")
print(f"Computer pieces: {[[i.first, i.second] for i in domino_set.player_2_set]}")
print(f"Player pieces: {[[i.first, i.second] for i in domino_set.player_1_set]}")
print(f"Domino snake: {[[max_overall.first, max_overall.second]]}")
